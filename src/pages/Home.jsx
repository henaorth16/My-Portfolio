    ...
    return <>
            <div id="home" className="text-secondary-200 text-center h-full w-full flex justify-center items-center">
                <div className="flex flex-col justify-center items-center md:w-1/2 w-3/4 gap-3 font-par">
                    ...
                    <a href={Resume} target="_blank" className="inline-flex items-center px-4 py-2 text-sm font-medium text-secondary-200 bg-secondary-900 rounded-md hover:bg-opacity-70  focus:z-10 focus:ring-1 focus:outline-none">
