    ...
    return <>
            <div id="home" className="text-secondary-200 text-center h-full w-full flex justify-center items-center">
                <div className="flex flex-col justify-center items-center md:w-1/2 w-3/4 gap-3 font-par">
                    ...
                    <Fade>
                    <h2 className="text-xl font-bold tracking-wider">Hello, Here is <Fade><span className="text-primary-500 text-[1.4rem] font-heading font-black">HENOK EMYAYE</span></Fade>  </h2>
                    </Fade>
                    <p className="font-par">Frontend Development, Problem Solving, Collaboration skill, JavaScript, Reactjs, Nextjs, TypeScript</p>
